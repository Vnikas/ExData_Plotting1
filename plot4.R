...
plot(data2$my_dates,data2$Global_active_power, type="line", xlab="", ylab="Global Active Power")
...
plot(data2$my_dates,data2$Voltage, type="line", xlab ="datetime", ylab="Voltage")

plot(data2$my_dates,data2$Global_reactive_power, type="line", xlab ="datetime", ylab="Global_reactive_power")
